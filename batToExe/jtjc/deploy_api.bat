...
call sshpass -p %password% ssh  %username%@%ip% "echo Deployment for user with " %currentIP% " was successful\, deployment time is：" %datetime% " >> /app/stc-jtjc/log/deploy.log;"
