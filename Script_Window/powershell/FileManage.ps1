...
$buttonStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BackgroundProperty, [System.Windows.Media.SolidColorBrush]$primaryColor)))
...
$buttonStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::PaddingProperty, (New-Object System.Windows.Thickness(12, 6, 12, 6)))))
...
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BackgroundProperty, [System.Windows.Media.Brushes]::White)))
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BorderBrushProperty, [System.Windows.Media.SolidColorBrush]$borderColor)))
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BorderThicknessProperty, (New-Object System.Windows.Thickness(1)))))
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::PaddingProperty, (New-Object System.Windows.Thickness(8, 4, 8, 4)))))
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::FontSizeProperty, 12)))
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::VerticalAlignmentProperty, [System.Windows.VerticalAlignment]::Center)))
$inputStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::MarginProperty, (New-Object System.Windows.Thickness(5)))))
$resources.Add("InputStyle", $inputStyle)

# 下拉框样式
$comboStyle = New-Object System.Windows.Style([System.Windows.Controls.ComboBox])
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BackgroundProperty, [System.Windows.Media.Brushes]::White)))
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BorderBrushProperty, [System.Windows.Media.SolidColorBrush]$borderColor)))
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::BorderThicknessProperty, (New-Object System.Windows.Thickness(1)))))
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::PaddingProperty, (New-Object System.Windows.Thickness(8, 4, 8, 4)))))
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::FontSizeProperty, 12)))
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::VerticalAlignmentProperty, [System.Windows.VerticalAlignment]::Center)))
$comboStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::MarginProperty, (New-Object System.Windows.Thickness(5)))))
$resources.Add("ComboStyle", $comboStyle)

# 标签样式
$labelStyle = New-Object System.Windows.Style([System.Windows.Controls.Label])
$labelStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::ForegroundProperty, [System.Windows.Media.SolidColorBrush]$textColor)))
$labelStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::FontSizeProperty, 12)))
$labelStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::VerticalAlignmentProperty, [System.Windows.VerticalAlignment]::Center)))
$labelStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Control]::MarginProperty, (New-Object System.Windows.Thickness(5, 0, 5, 0)))))
$resources.Add("LabelStyle", $labelStyle)

# 卡片样式
$cardStyle = New-Object System.Windows.Style([System.Windows.Controls.Border])
$cardStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Border]::BackgroundProperty, [System.Windows.Media.Brushes]::White)))
$cardStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Border]::BorderBrushProperty, [System.Windows.Media.SolidColorBrush]$borderColor)))
$cardStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Border]::BorderThicknessProperty, (New-Object System.Windows.Thickness(1)))))
$cardStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Border]::CornerRadiusProperty, (New-Object System.Windows.CornerRadius(8)))))
$cardStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Border]::PaddingProperty, (New-Object System.Windows.Thickness(15)))))
$cardStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.Border]::MarginProperty, (New-Object System.Windows.Thickness(15)))))
$resources.Add("CardStyle", $cardStyle)

# 数据网格样式
$dataGridStyle = New-Object System.Windows.Style([System.Windows.Controls.DataGrid])
$dataGridStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.DataGrid]::BackgroundProperty, [System.Windows.Media.Brushes]::White)))
$dataGridStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.DataGrid]::BorderBrushProperty, [System.Windows.Media.SolidColorBrush]$borderColor)))
$dataGridStyle.Setters.Add((New-Object System.Windows.Setter([System.Windows.Controls.DataGrid]::BorderThicknessProperty, (New-Object System.Windows.Thickness(1)))))
...
function Apply-Filters
{
    ...
    {
        $allData = $allData | Where-Object {
            $_.RawDate -ge $startDate
        }
    }
    if ($endDate)
    {
        $allData = $allData | Where-Object {
            $_.RawDate -le $endDate
        }
    }
...
# 日期时间输入框事件
$startDateTimeBox.Add_TextChanged({
    # 仅在输入完成后验证
})

$endDateTimeBox.Add_TextChanged({
    # 仅在输入完成后验证
})

# 大小输入框事件
$minSizeBox.Add_TextChanged({
    # 输入变化时不立即筛选
})

$maxSizeBox.Add_TextChanged({
    # 输入变化时不立即筛选
})

# 单位选择框事件
$minSizeUnit.Add_SelectionChanged({
    Apply-Filters
})

$maxSizeUnit.Add_SelectionChanged({
    Apply-Filters
})
